...
const Ki = (e) => new xi(typeof e == "string" ? e : e + "", void 0, ue), Lt = (e, ...t) => {
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const { is: Ji, defineProperty: Xi, getOwnPropertyDescriptor: Qi, getOwnPropertyNames: t1, getOwnPropertySymbols: e1, getPrototypeOf: i1 } = Object, it = globalThis, Ae = it.trustedTypes, s1 = Ae ? Ae.emptyScript : "", jt = it.reactiveElementPolyfillSupport, gt = (e, t) => e, Tt = { toAttribute(e, t) {
  switch (t) {
    case Boolean:
      e = e ? s1 : null;
      break;
  ...
  return i;
} }, pe = (e, t) => !Ji(e, t), He = { attribute: !0, type: String, converter: Tt, reflect: !1, useDefault: !1, hasChanged: pe };
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const Ct = globalThis, Ve = (e) => e, Dt = Ct.trustedTypes, $e = Dt ? Dt.createPolicy("lit-html", { createHTML: (e) => e }) : void 0, ki = "$lit$", tt = `lit$${Math.random().toFixed(9).slice(2)}$`, Ti = "?" + tt, o1 = `<${Ti}>`, lt = document, yt = () => lt.createComment(""), vt = (e) => e === null || typeof e != "object" && typeof e != "function", fe = Array.isArray, n1 = (e) => fe(e) || typeof (e == null ? void 0 : e[Symbol.iterator]) == "function", Nt = `[ 	
\f\r]`, _t = /<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g, Me = /-->/g, we = />/g, ot = RegExp(`>|${Nt}(?:([^\\s"'>=/]+)(${Nt}*=${Nt}*(?:[^ 	
\f\r"'\`<>=]|("|')|))|$)`, "g"), Ee = /'/g, Se = /"/g, Di = /^(?:script|style|textarea|title)$/i, a1 = (e) => (t, ...i) => ({ _$litType$: e, strings: t, values: i }), _ = a1(1), R = Symbol.for("lit-noChange"), k = Symbol.for("lit-nothing"), xe = /* @__PURE__ */ new WeakMap(), at = lt.createTreeWalker(lt, 129);
function zi(e, t) {
...
const r1 = (e, t) => {
  ...
  for (let r = 0; r < i; r++) {
    ...
    n += a === _t ? l + o1 : h >= 0 ? (s.push(c), l.slice(0, h) + ki + l.slice(h) + tt + f) : l + tt + (h === -2 ? r : f);
  }
      ...
      if (o.nodeType === 1) {
        ...
        if (Di.test(o.tagName)) {
          ...
          if (p > 0) {
            ...
            for (let f = 0; f < p; f++) o.append(h[f], yt()), at.nextNode(), l.push({ type: 2, index: ++n });
            o.append(h[p], yt());
          }
        }
      } else if (o.nodeType === 8) if (o.data === Ti) l.push({ type: 2, index: n });
      else {
        let h = -1;
...
class pt {
  ...
  _$AI(t, i = this) {
    t = ut(this, t, i), vt(t) ? t === k || t == null || t === "" ? (this._$AH !== k && this._$AR(), this._$AH = k) : t !== this._$AH && t !== R && this._(t) : t._$litType$ !== void 0 ? this.$(t) : t.nodeType !== void 0 ? this.T(t) : n1(t) ? this.k(t) : this._(t);
  }
  O(t) {
...
class It {
  ...
  _$AI(t, i = this, s, o) {
    ...
    if (n === void 0) t = ut(this, t, i, 0), a = !vt(t) || t !== this._$AH && t !== R, a && (this._$AH = t);
      ...
      const r = t;
      let l, c;
      for (t = n[0], l = 0; l < n.length - 1; l++) c = ut(this, r[s + l], i, l), c === R && (c = this._$AH[l]), a || (a = !vt(c) || c !== this._$AH[l]), c === k ? t = k : t !== k && (t += (c ?? "") + n[l + 1]), this._$AH[l] = c;
    }
    a && !o && this.j(t);
  }
  j(t) {
...
const p1 = { I: pt }, Ut = Ct.litHtmlPolyfillSupport;
...
var Si;
B._$litElement$ = !0, B.finalized = !0, (Si = rt.litElementHydrateSupport) == null || Si.call(rt, { LitElement: B });
const Wt = rt.litElementPolyfillSupport;
Wt == null || Wt({ LitElement: B });
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const _1 = { attribute: !0, type: String, converter: Tt, reflect: !1, hasChanged: pe }, m1 = (e = _1, t, i) => {
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const { I: g1 } = p1, ke = (e) => e, Te = () => document.createComment(""), mt = (e, t, i) => {
  var n;
  ...
  return i;
}, nt = (e, t, i = e) => (e._$AI(t, i), e), C1 = {}, y1 = (e, t = C1) => e._$AH = t, v1 = (e) => e._$AH, qt = (e) => {
...
}, T = (e) => e.substr(0, e.indexOf(".")), co = (e) => (t, i) => e.includes(t, i), ge = "unavailable", ho = "unknown", uo = "off", po = [ge, ho], fo = co(po), _o = (e) => {
...
), Vo = (e, t) => e < t ? -1 : e > t ? 1 : 0, Ii = (e, t, i = void 0) => Intl != null && Intl.Collator ? Ho(i).compare(e, t) : Vo(e.toLowerCase(), t.toLowerCase()), kt = (e, t) => {
  if (e === t)
    return !0;
...
function Pi(e, t, i, s, o) {
  ...
  return Object.values(e).filter((u) => {
    var y, V, S;
    const C = u.entity_id.split(".")[0];
    if (!m.has(C)) return !1;
    if (C === "update")
      return !u.hidden;
    const v = u.device_id ? b.get(u.device_id) : void 0;
    if (!(u.area_id != null || v && v.area_id != null) || r && !((((y = u.labels) == null ? void 0 : y.some((U) => r.includes(U))) ?? !1) || (((V = v == null ? void 0 : v.labels) == null ? void 0 : V.some((U) => r.includes(U))) ?? !1)) || n && !(u.area_id !== void 0 && u.area_id !== null && n.includes(u.area_id) || v && v.area_id !== void 0 && v.area_id !== null && n.includes(v.area_id)))
      return !1;
    if (a) {
...
const F = (e, t) => e ? typeof e == "object" ? Object.entries(e).reduce(
  ...
  {}
)) : {}, Ro = (e, t, i) => t && t._parsedCss ? t._parsedCss : e ? F(e) : {}, jo = Lt`
...
const Jo = [
      ...
      (t, i, s, o) => {
        ...
        if (i === "state") {
          ...
          return a.sort((c, d) => {
            ...
            if (h !== p) return h - p;
            const f = T(c.entity_id), m = T(d.entity_id), b = o ? j(o, c.state, f) : c.state, g = o ? j(o, d.state, m) : d.state, u = (b || "").localeCompare(g || "");
  ...
  _getPopupCardConfig(t) {
    ...
    const s = T(t.entity_id), o = this.selectedDomain || s, n = this.selectedDomain ? this.selectedDeviceClass : (v = (C = (u = (g = this.hass) == null ? void 0 : g.states) == null ? void 0 : u[t.entity_id]) == null ? void 0 : C.attributes) == null ? void 0 : v.device_class, a = z(o, n), r = typeof (i == null ? void 0 : i.getCustomizationForType) == "function" ? i.getCustomizationForType(a) : void 0, l = r == null ? void 0 : r.popup_card, c = l && typeof l.type == "string" && l.type || "tile", d = c === "tile" ? {
      ...Fi(s, t),
      features_position: i._config.inline_feature ? "inline" : "bottom"
    } : {};
    let h = {};
    if (l && typeof l == "object") {
      const { type: D, entity: y, ...V } = l;
      h = V;
    } else
      h = {};
    const p = {
  ...
  _isEntityActive(t) {
    var o;
    const i = this.selectedDomain || T(t.entity_id), s = this.selectedDeviceClass || t.attributes.device_class;
  ...
  render() {
    ...
    r === void 0 && n && (h = !0);
    const p = this.sortEntitiesForPopup(d), f = new Set(d.map((L) => L.entity_id));
    ...
    ), b = (t == null ? void 0 : t.ungroup_areas) === !0 || ((V = l == null ? void 0 : l._config) == null ? void 0 : V.ungroupAreas) === !0 || ((S = l == null ? void 0 : l._config) == null ? void 0 : S.ungroup_areas) === !0 || ((I = l == null ? void 0 : l._config) == null ? void 0 : I.area_grouping) !== void 0 && ((U = l == null ? void 0 : l._config) == null ? void 0 : U.area_grouping) === !1, g = m.length ? Math.max(...m.map(([, L]) => L.length)) : 0, u = b ? Math.min(o, Math.max(1, d.length)) : Math.min(o, Math.max(1, g));
    this.style.setProperty("--columns", String(u));
    const C = z(n, a), v = typeof (l == null ? void 0 : l.getCustomizationForType) == "function" ? l.getCustomizationForType(C) : void 0, D = (v == null ? void 0 : v.invert) === !0;
    return _`
      <ha-adaptive-dialog
        .hass=${this.hass}
        .open=${this.open}
...
const Xo = (e, t, i, s) => s ? [] : Object.values(e).filter(
  ...
  return e.extra_entities ? e.extra_entities.reduce((o, n) => {
    ...
    const l = s.indexOf(n), c = l >= 0 ? l : 0, d = Ri(
      e,
      n,
      void 0,
      a,
      ...
      void 0,
      i
    ) || ((r == null ? void 0 : r.activate_state_color) ?? e.activate_state_color ? Ao(a) : void 0) || e.color, f = No(
      e,
      n,
      void 0,
      i
  ...
  return l.length ? i.map((c) => s[c]).filter((c) => c ? l.every((d) => Ni(e, c, d, {
    entityMap: o,
    deviceMap: n,
    areaMap: a
...
let $ = class extends B {
  constructor() {
    ...
    ), this._customizationIndexMemo = H(Bi), this._computePersonIdsMemo = H(Xo), this._mapPersonIdsToStatesMemo = H(
      (e, t) => Qo(e, t),
      (e, t) => {
        const [i, s] = e, [o, n] = t;
        if (i !== o) return !1;
    ...
    ), this._computeGroupItemsMemo = H(en), this._computeDomainItemsMemo = H(sn), this._computeDeviceClassItemsMemo = H(on), this._computeEntityMap = H(
      ...
      (e, t, i, s, o, n, a, r) => {
        ...
        return i.forEach((f) => {
          ...
          const m = e.get(f.group_id) || [], b = Number(
            ...
            h,
            p,
            (C) => this._isEntityRecentlyInactive(
              C,
              b
            )
          );
  ...
  _isEntityRecentlyInactive(e, t, i = Date.now()) {
    if (!Number.isFinite(t) || t <= 0 || e.state === "unavailable" || e.state === "unknown")
      return !1;
    const s = T(e.entity_id), o = e.attributes.device_class, n = this.getCustomizationForType(
      z(s, o)
    );
    if (Ot(
      e,
  ...
  isEntityVisibleAsActive(e, t, i) {
    const s = t || T(e.entity_id), o = i ?? e.attributes.device_class, n = z(s, o), a = this.getCustomizationForType(n), r = (a == null ? void 0 : a.invert) === !0, l = (a == null ? void 0 : a.recently_active_minutes) ?? this._config.recently_active_minutes ?? 0;
    return ko(
      e,
      s,
      o,
  ...
  _scheduleRecentActivityUpdate() {
    ...
    for (const o of Object.values(this.hass.states)) {
      const n = T(o.entity_id), a = o.attributes.device_class, r = this.getCustomizationForType(
        z(n, a)
      ), l = Number(
  ...
  _getInlineCardConfig(e, t) {
    ...
    const s = T(t.entity_id), o = t.attributes.device_class, n = this.getCustomizationForType(
      z(s, o)
  ...
  _getOrCreateInlineCard(e, t) {
    ...
    const r = document.createElement("div");
    return r.classList.add("inline-card-placeholder"), this._inlineCardElementCache.set(i, { hash: o, el: r }), Ce(this.hass, s).then((l) => {
  ...
  render() {
    ...
    return this._shouldHideCard ? _`` : this._config.ungroup_entities ? _`
      ...
      >
        ${W(
      a,
      ({ entity: r }) => r.entity_id,
      ({ entity: r, contextKey: l }) => _`
            <div class="inline-entity-card">
              ${this._getOrCreateInlineCard(l, r)}
            </div>
          `
    )}
      </div>
...
var bn = Object.defineProperty, Ln = Object.getOwnPropertyDescriptor, st = (e, t, i, s) => {
...
let K = class extends B {
  ...
  async updated(e) {
    ...
    if (!(!this.hass || !this._config) && e.has("_config")) {
      ...
      if (b || m || f || g) {
        const u = this._dynamicOrder, v = this.possibleToggleDomains.map((D) => this._normalizeContentEntry(D)).sort((D, y) => {
          const V = u.indexOf(D), S = u.indexOf(y);
          return (V === -1 ? u.length : V) - (S === -1 ? u.length : S);
        });
        this._config = {
          ...this._config,
          content: [...v]
      ...
      if (!X(n, a)) {
        let u = [...o];
        u = u.filter((C) => a.includes(C)), X(u, o) || (this._config = {
          ...this._config,
          extra_entities: u
        }, t = !0);
      }
  ...
  _groupAllEntitiesByDomain() {
    ...
    if (n.length > 0) {
      const y = o.person || [], V = new Set(y.map((I) => I.entity_id)), S = n.filter(
        (I) => !V.has(I.entity_id)
      );
      o.person = [...y, ...S];
    }
