 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const { is: Q1, defineProperty: ti, getOwnPropertyDescriptor: ei, getOwnPropertyNames: ii, getOwnPropertySymbols: si, getPrototypeOf: oi } = Object, it = globalThis, Le = it.trustedTypes, ni = Le ? Le.emptyScript : "", jt = it.reactiveElementPolyfillSupport, gt = (e, t) => e, Tt = { toAttribute(e, t) {
  switch (t) {
    case Boolean:
      e = e ? ni : null;
      break;
  ...
  return i;
} }, pe = (e, t) => !Q1(e, t), Ae = { attribute: !0, type: String, converter: Tt, reflect: !1, useDefault: !1, hasChanged: pe };
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const Ct = globalThis, He = (e) => e, Dt = Ct.trustedTypes, Ve = Dt ? Dt.createPolicy("lit-html", { createHTML: (e) => e }) : void 0, x1 = "$lit$", tt = `lit$${Math.random().toFixed(9).slice(2)}$`, k1 = "?" + tt, ai = `<${k1}>`, lt = document, yt = () => lt.createComment(""), vt = (e) => e === null || typeof e != "object" && typeof e != "function", fe = Array.isArray, ri = (e) => fe(e) || typeof (e == null ? void 0 : e[Symbol.iterator]) == "function", Ut = `[ 	
\f\r]`, mt = /<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g, $e = /-->/g, Me = />/g, ot = RegExp(`>|${Ut}(?:([^\\s"'>=/]+)(${Ut}*=${Ut}*(?:[^ 	
\f\r"'\`<>=]|("|')|))|$)`, "g"), we = /'/g, Ee = /"/g, z1 = /^(?:script|style|textarea|title)$/i, li = (e) => (t, ...i) => ({ _$litType$: e, strings: t, values: i }), m = li(1), j = Symbol.for("lit-noChange"), z = Symbol.for("lit-nothing"), Se = /* @__PURE__ */ new WeakMap(), at = lt.createTreeWalker(lt, 129);
function T1(e, t) {
...
class pt {
  ...
  _$AI(t, i = this) {
    t = ut(this, t, i), vt(t) ? t === z || t == null || t === "" ? (this._$AH !== z && this._$AR(), this._$AH = z) : t !== this._$AH && t !== j && this._(t) : t._$litType$ !== void 0 ? this.$(t) : t.nodeType !== void 0 ? this.T(t) : ri(t) ? this.k(t) : this._(t);
  }
  O(t) {
...
class It {
  ...
  _$AI(t, i = this, s, o) {
    ...
    if (n === void 0) t = ut(this, t, i, 0), a = !vt(t) || t !== this._$AH && t !== j, a && (this._$AH = t);
      ...
      const r = t;
      let l, c;
      for (t = n[0], l = 0; l < n.length - 1; l++) c = ut(this, r[s + l], i, l), c === j && (c = this._$AH[l]), a || (a = !vt(c) || c !== this._$AH[l]), c === z ? t = z : t !== z && (t += (c ?? "") + n[l + 1]), this._$AH[l] = c;
    }
    a && !o && this.j(t);
  }
  j(t) {
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const gi = { attribute: !0, type: String, converter: Tt, reflect: !1, hasChanged: pe }, Ci = (e = gi, t, i) => {
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const D1 = "important", Ai = " !" + D1, E = Zt(class extends Gt {
  constructor(e) {
    var t;
...
}, T = (e) => e.substr(0, e.indexOf(".")), uo = (e) => (t, i) => e.includes(t, i), _e = "unavailable", po = "unknown", fo = "off", mo = [_e, po], _o = uo(mo), go = (e) => {
...
), Mo = (e, t) => e < t ? -1 : e > t ? 1 : 0, O1 = (e, t, i = void 0) => Intl != null && Intl.Collator ? $o(i).compare(e, t) : Mo(e.toLowerCase(), t.toLowerCase()), zt = (e, t) => {
  if (e === t)
    return !0;
...
const et = {
  ...
  binary_sensor: {
    ...
    plug: { on: r1, off: l1 },
    power: { on: $s, off: Xt },
    battery: { on: zi, off: ki },
    battery_charging: { on: Ti, off: Di },
    gas: { on: ns, off: os },
...
const Ko = [
      ...
      (t, i, s, o) => {
        ...
        if (i === "state") {
          ...
          return a.sort((c, d) => {
            ...
            if (h !== p) return h - p;
            const u = T(c.entity_id), _ = T(d.entity_id), v = o ? U(o, c.state, u) : c.state, g = o ? U(o, d.state, _) : d.state, f = (v || "").localeCompare(g || "");
  ...
  _isEntityActive(t) {
    var r;
    const i = this.selectedDomain || T(t.entity_id), s = this.selectedDeviceClass || t.attributes.device_class, o = Z(i, s), n = typeof ((r = this.card) == null ? void 0 : r.getCustomizationForType) == "function" ? this.card.getCustomizationForType(o) : void 0, a = (n == null ? void 0 : n.invert) === !0;
    return Z1(t, i, s, a);
  }
  _getCurrentEntities() {
