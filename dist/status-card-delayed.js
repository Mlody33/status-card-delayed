 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const { is: Ji, defineProperty: Xi, getOwnPropertyDescriptor: Qi, getOwnPropertyNames: t1, getOwnPropertySymbols: e1, getPrototypeOf: i1 } = Object, it = globalThis, Le = it.trustedTypes, s1 = Le ? Le.emptyScript : "", Nt = it.reactiveElementPolyfillSupport, gt = (e, t) => e, kt = { toAttribute(e, t) {
  switch (t) {
    case Boolean:
      e = e ? s1 : null;
      break;
...
let ht = class extends HTMLElement {
  ...
  static finalize() {
    ...
    if (this.finalized = !0, this._$Ei(), this.hasOwnProperty(gt("properties"))) {
      const i = this.properties, s = [...t1(i), ...e1(i)];
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const yt = globalThis, Ve = (e) => e, Dt = yt.trustedTypes, $e = Dt ? Dt.createPolicy("lit-html", { createHTML: (e) => e }) : void 0, Ti = "$lit$", tt = `lit$${Math.random().toFixed(9).slice(2)}$`, ki = "?" + tt, o1 = `<${ki}>`, lt = document, Ct = () => lt.createComment(""), vt = (e) => e === null || typeof e != "object" && typeof e != "function", fe = Array.isArray, n1 = (e) => fe(e) || typeof (e == null ? void 0 : e[Symbol.iterator]) == "function", jt = `[ 	
\f\r]`, _t = /<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g, Me = /-->/g, we = />/g, ot = RegExp(`>|${jt}(?:([^\\s"'>=/]+)(${jt}*=${jt}*(?:[^ 	
\f\r"'\`<>=]|("|')|))|$)`, "g"), Ee = /'/g, Se = /"/g, Di = /^(?:script|style|textarea|title)$/i, a1 = (e) => (t, ...i) => ({ _$litType$: e, strings: t, values: i }), _ = a1(1), B = Symbol.for("lit-noChange"), T = Symbol.for("lit-nothing"), xe = /* @__PURE__ */ new WeakMap(), at = lt.createTreeWalker(lt, 129);
function zi(e, t) {
...
const r1 = (e, t) => {
  ...
  for (let r = 0; r < i; r++) {
    ...
    n += a === _t ? l + o1 : h >= 0 ? (s.push(c), l.slice(0, h) + Ti + l.slice(h) + tt + f) : l + tt + (h === -2 ? r : f);
  }
...
class bt {
  constructor({ strings: t, _$litType$: i }, s) {
    ...
    this.parts = [];
    let n = 0, a = 0;
    const r = t.length - 1, l = this.parts, [c, d] = r1(t, i);
    ...
    for (; (o = at.nextNode()) !== null && l.length < r; ) {
      if (o.nodeType === 1) {
        if (o.hasAttributes()) for (const h of o.getAttributeNames()) if (h.endsWith(Ti)) {
          ...
          l.push({ type: 1, index: n, name: m[2], strings: f, ctor: m[1] === "." ? c1 : m[1] === "?" ? d1 : m[1] === "@" ? h1 : It }), o.removeAttribute(h);
...
class l1 {
  ...
  u(t) {
    ...
    for (; l !== void 0; ) {
      if (a === l.index) {
        let c;
        l.type === 2 ? c = new pt(n, n.nextSibling, this, t) : l.type === 1 ? c = new l.ctor(n, l.name, l.strings, this, t) : l.type === 6 && (c = new u1(n, this, t)), this._$AV.push(c), l = s[++r];
      }
...
class pt {
  ...
  _$AI(t, i = this) {
    t = ut(this, t, i), vt(t) ? t === T || t == null || t === "" ? (this._$AH !== T && this._$AR(), this._$AH = T) : t !== this._$AH && t !== B && this._(t) : t._$litType$ !== void 0 ? this.$(t) : t.nodeType !== void 0 ? this.T(t) : n1(t) ? this.k(t) : this._(t);
  }
  O(t) {
  ...
  $(t) {
    ...
    if (((n = this._$AH) == null ? void 0 : n._$AD) === o) this._$AH.p(i);
      ...
      const a = new l1(o, this), r = a.u(this.options);
...
const p1 = { I: pt }, Ut = yt.litHtmlPolyfillSupport;
...
let R = class extends ht {
  ...
  update(t) {
    const i = this.render();
    this.hasUpdated || (this.renderOptions.isConnected = this.isConnected), super.update(t), this._$Do = f1(i, this.renderRoot, this.renderOptions);
  }
  connectedCallback() {
    var t;
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const _1 = { attribute: !0, type: String, converter: kt, reflect: !1, hasChanged: pe }, m1 = (e = _1, t, i) => {
...
function w(e) {
  return (t, i) => typeof i == "object" ? m1(e, t, i) : ((s, o, n) => {
...
const { I: g1 } = p1, Te = (e) => e, ke = () => document.createComment(""), mt = (e, t, i) => {
  ...
  return i;
}, nt = (e, t, i = e) => (e._$AI(t, i), e), y1 = {}, C1 = (e, t = y1) => e._$AH = t, v1 = (e) => e._$AH, qt = (e) => {
...
const De = (e, t, i) => {
  ...
  update(e, [t, i, s]) {
    const o = v1(e), { values: n, keys: a } = this.dt(t, i, s);
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const Oi = "important", b1 = " !" + Oi, E = Zt(class extends Gt {
  constructor(e) {
    var t;
  ...
  update(e, [t]) {
    ...
    for (const s in t) {
      ...
      if (o != null) {
        this.ft.add(s);
        const n = typeof o == "string" && o.endsWith(b1);
...
function To(e, t, i, s = !1, o = 0, n = Date.now()) {
  ...
  return Number.isFinite(r) && n - r < a * 60 * 1e3;
}
let q = null;
function Gi(e, t) {
  var i, s;
...
const et = {
  alarm_control_panel: { on: $1, off: M1 },
  siren: { on: z1, off: Re },
  lock: { on: oi, off: si },
  light: { on: hs, off: us },
  media_player: { on: R1, off: B1 },
  climate: { on: Us, off: Ws },
  humidifier: { on: H1, off: V1 },
  switch: {
    on: Qt,
    off: te,
    switch: { on: Qt, off: te },
  ...
  binary_sensor: {
    ...
    running: { on: Ls, off: bs },
    plug: { on: li, off: ci },
    power: { on: Hs, off: Xt },
    battery: { on: x1, off: S1 },
    battery_charging: { on: T1, off: k1 },
    gas: { on: ss, off: is },
...
const Go = {
  ...
  recently_active_minutes: () => "Show recently active entities (minutes)",
...
let H = class extends R {
      ...
      (e, t, i, s, o, n, a, r) => {
        ...
        return i.forEach((f) => {
          ...
          const m = e.get(f.group_id) || [], b = Number(
            ((u = this.getCustomizationForType(f.group_id)) == null ? void 0 : u.recently_active_minutes) ?? a.recently_active_minutes ?? 0
          ), g = an(
            c,
            f,
            m,
  ...
  _isEntityRecentlyInactive(e, t, i = Date.now()) {
    ...
    return Number.isFinite(a) && i - a < t * 60 * 1e3;
  }
  isEntityVisibleAsActive(e, t, i) {
    const s = t || k(e.entity_id), o = i ?? e.attributes.device_class, n = z(s, o), a = this.getCustomizationForType(n), r = (a == null ? void 0 : a.invert) === !0, l = (a == null ? void 0 : a.recently_active_minutes) ?? this._config.recently_active_minutes ?? 0;
    return To(
      e,
      s,
      o,
  ...
  _scheduleRecentActivityUpdate() {
    ...
    for (const o of Object.values(this.hass.states)) {
      const n = k(o.entity_id), a = o.attributes.device_class, r = this.getCustomizationForType(
        ...
        (r == null ? void 0 : r.recently_active_minutes) ?? this._config.recently_active_minutes ?? 0
      );
    ...
    for (const o of this._config.rulesets || []) {
      const n = Number(
        ((s = this.getCustomizationForType(o.group_id)) == null ? void 0 : s.recently_active_minutes) ?? this._config.recently_active_minutes ?? 0
      );
    ...
    for (const o of i)
      for (const n of Object.values(this.hass.states)) {
        ...
        const a = Date.parse(n.last_changed) + o * 60 * 1e3;
        a > e && a < t && (t = a);
      }
  ...
  renderGroupTab(e, t) {
    ...
    const n = e.group_id || `${this.hass.localize("component.group.entity_component._.name")} ${t + 1}`, a = e.group_icon || ts, r = wi(
      this._config,
      n,
      void 0,
      this._customizationIndexMemo(this._config.customization)
