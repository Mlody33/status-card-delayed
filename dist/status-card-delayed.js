...
var Si;
F._$litElement$ = !0, F.finalized = !0, (Si = rt.litElementHydrateSupport) == null || Si.call(rt, { LitElement: F });
...
const R = (e, t) => e ? typeof e == "object" ? Object.entries(e).reduce(
  ...
  {}
)) : {}, Bo = (e, t, i) => t && t._parsedCss ? t._parsedCss : e ? R(e) : {}, No = At`
  :host {
    position: relative;
  }
...
function Ht(e, t, i) {
  return t ? (i || Fi(e.customization)).get(t.toLowerCase()) : void 0;
}
...
let H = class extends F {
  constructor() {
    ...
    ), this._customizationIndexMemo = V(Fi), this._computePersonIdsMemo = V(Xo), this._mapPersonIdsToStatesMemo = V(
      (e, t) => Qo(e, t),
      (e, t) => {
        const [i, s] = e, [o, n] = t;
        if (i !== o) return !1;
  ...
  setConfig(e) {
    ...
    this._parsedGlobalCardCss = R(i.card), this._parsedGlobalCss = R(i.button), this._parsedGlobalIconCss = R(i.icon), this._parsedGlobalNameCss = R(i.name), this._parsedGlobalStateCss = R(i.state);
  }
  _showPopup(e, t, i) {
    e.dispatchEvent(
      new CustomEvent("show-dialog", {
  ...
  disconnectedCallback() {
    super.disconnectedCallback(), clearTimeout(this._resetDomainTimeout), clearTimeout(this._resetGroupTimeout), clearTimeout(this._recentActivityTimeout), this._inlineCardElementCache.clear();
  }
  willUpdate(e) {
  ...
  updated(e) {
    ...
    this._playTileAnimations(), this._ensureRegistryData(), this._scheduleRecentActivityUpdate();
...
H.TILE_ANIMATION_DURATION = 260;
H.TILE_ANIMATION_EASING = "cubic-bezier(0.2, 0.8, 0.2, 1)";
M([
  w({ type: Object })
...
var Cn = Object.defineProperty, vn = Object.getOwnPropertyDescriptor, Ft = (e, t, i, s) => {
