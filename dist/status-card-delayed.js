 ...
 */
const kt = globalThis, he = kt.ShadowRoot && (kt.ShadyCSS === void 0 || kt.ShadyCSS.nativeShadow) && "adoptedStyleSheets" in Document.prototype && "replace" in CSSStyleSheet.prototype, ue = Symbol(), ve = /* @__PURE__ */ new WeakMap();
let S1 = class {
  constructor(t, i, s) {
...
const J1 = (e) => new S1(typeof e == "string" ? e : e + "", void 0, ue), At = (e, ...t) => {
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const { is: Q1, defineProperty: ti, getOwnPropertyDescriptor: ei, getOwnPropertyNames: ii, getOwnPropertySymbols: si, getPrototypeOf: oi } = Object, it = globalThis, Le = it.trustedTypes, ni = Le ? Le.emptyScript : "", jt = it.reactiveElementPolyfillSupport, gt = (e, t) => e, zt = { toAttribute(e, t) {
  switch (t) {
    case Boolean:
      e = e ? ni : null;
      break;
  ...
  return i;
} }, pe = (e, t) => !Q1(e, t), Ae = { attribute: !0, type: String, converter: zt, reflect: !1, useDefault: !1, hasChanged: pe };
...
let ht = class extends HTMLElement {
  ...
  _$AK(t, i) {
    ...
    if (o !== void 0 && this._$Em !== o) {
      const r = s.getPropertyOptions(o), l = typeof r.converter == "function" ? { fromAttribute: r.converter } : ((n = r.converter) == null ? void 0 : n.fromAttribute) !== void 0 ? r.converter : zt;
      this._$Em = o;
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const Ct = globalThis, He = (e) => e, Tt = Ct.trustedTypes, Ve = Tt ? Tt.createPolicy("lit-html", { createHTML: (e) => e }) : void 0, x1 = "$lit$", tt = `lit$${Math.random().toFixed(9).slice(2)}$`, k1 = "?" + tt, ai = `<${k1}>`, lt = document, yt = () => lt.createComment(""), vt = (e) => e === null || typeof e != "object" && typeof e != "function", fe = Array.isArray, ri = (e) => fe(e) || typeof (e == null ? void 0 : e[Symbol.iterator]) == "function", Ut = `[ 	
\f\r]`, mt = /<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g, $e = /-->/g, Me = />/g, ot = RegExp(`>|${Ut}(?:([^\\s"'>=/]+)(${Ut}*=${Ut}*(?:[^ 	
\f\r"'\`<>=]|("|')|))|$)`, "g"), we = /'/g, Ee = /"/g, D1 = /^(?:script|style|textarea|title)$/i, li = (e) => (t, ...i) => ({ _$litType$: e, strings: t, values: i }), m = li(1), j = Symbol.for("lit-noChange"), D = Symbol.for("lit-nothing"), Se = /* @__PURE__ */ new WeakMap(), at = lt.createTreeWalker(lt, 129);
function z1(e, t) {
...
const ci = (e, t) => {
  ...
  for (let r = 0; r < i; r++) {
    const l = e[r];
    let c, d, h = -1, p = 0;
    for (; p < l.length && (a.lastIndex = p, d = a.exec(l), d !== null); ) p = a.lastIndex, a === mt ? d[1] === "!--" ? a = $e : d[1] !== void 0 ? a = Me : d[2] !== void 0 ? (D1.test(d[2]) && (o = RegExp("</" + d[2], "g")), a = ot) : d[3] !== void 0 && (a = ot) : a === ot ? d[0] === ">" ? (a = o ?? mt, h = -1) : d[1] === void 0 ? h = -2 : (h = a.lastIndex - d[2].length, c = d[1], a = d[3] === void 0 ? ot : d[3] === '"' ? Ee : we) : a === Ee || a === we ? a = ot : a === $e || a === Me ? a = mt : (a = ot, o = void 0);
    const u = a === ot && e[r + 1].startsWith("/>") ? " " : "";
    n += a === mt ? l + ai : h >= 0 ? (s.push(c), l.slice(0, h) + x1 + l.slice(h) + tt + u) : l + tt + (h === -2 ? r : u);
  }
...
class bt {
  constructor({ strings: t, _$litType$: i }, s) {
    ...
    this.parts = [];
    let n = 0, a = 0;
    const r = t.length - 1, l = this.parts, [c, d] = ci(t, i);
    ...
    for (; (o = at.nextNode()) !== null && l.length < r; ) {
      if (o.nodeType === 1) {
        if (o.hasAttributes()) for (const h of o.getAttributeNames()) if (h.endsWith(x1)) {
          const p = d[a++], u = o.getAttribute(h).split(tt), _ = /([.?@])?(.*)/.exec(p);
          l.push({ type: 1, index: n, name: _[2], strings: u, ctor: _[1] === "." ? hi : _[1] === "?" ? ui : _[1] === "@" ? pi : It }), o.removeAttribute(h);
...
class di {
  ...
  u(t) {
    ...
    for (; l !== void 0; ) {
      if (a === l.index) {
        let c;
        l.type === 2 ? c = new pt(n, n.nextSibling, this, t) : l.type === 1 ? c = new l.ctor(n, l.name, l.strings, this, t) : l.type === 6 && (c = new fi(n, this, t)), this._$AV.push(c), l = s[++r];
      }
...
class pt {
  ...
  _$AI(t, i = this) {
    t = ut(this, t, i), vt(t) ? t === D || t == null || t === "" ? (this._$AH !== D && this._$AR(), this._$AH = D) : t !== this._$AH && t !== j && this._(t) : t._$litType$ !== void 0 ? this.$(t) : t.nodeType !== void 0 ? this.T(t) : ri(t) ? this.k(t) : this._(t);
  }
  O(t) {
  ...
  _(t) {
    this._$AH !== D && vt(this._$AH) ? this._$AA.nextSibling.data = t : this.T(lt.createTextNode(t)), this._$AH = t;
  }
  $(t) {
    var n;
    ...
    if (((n = this._$AH) == null ? void 0 : n._$AD) === o) this._$AH.p(i);
      ...
      const a = new di(o, this), r = a.u(this.options);
...
class It {
  ...
  _$AI(t, i = this, s, o) {
    ...
    let a = !1;
    if (n === void 0) t = ut(this, t, i, 0), a = !vt(t) || t !== this._$AH && t !== j, a && (this._$AH = t);
    else {
      const r = t;
      let l, c;
      for (t = n[0], l = 0; l < n.length - 1; l++) c = ut(this, r[s + l], i, l), c === j && (c = this._$AH[l]), a || (a = !vt(c) || c !== this._$AH[l]), c === D ? t = D : t !== D && (t += (c ?? "") + n[l + 1]), this._$AH[l] = c;
    }
    a && !o && this.j(t);
  }
  j(t) {
...
const mi = { I: pt }, Nt = Ct.litHtmlPolyfillSupport;
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const gi = { attribute: !0, type: String, converter: zt, reflect: !1, hasChanged: pe }, Ci = (e = gi, t, i) => {
...
const { I: yi } = mi, xe = (e) => e, ke = () => document.createComment(""), _t = (e, t, i) => {
  ...
  return i;
}, nt = (e, t, i = e) => (e._$AI(t, i), e), vi = {}, bi = (e, t = vi) => e._$AH = t, Li = (e) => e._$AH, qt = (e) => {
...
const De = (e, t, i) => {
  ...
  update(e, [t, i, s]) {
    ...
    else if (c === void 0 && (c = De(a, u, _), d = De(r, h, p)), c.has(r[h])) if (c.has(r[p])) {
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const T1 = "important", Ai = " !" + T1, E = Zt(class extends Gt {
  constructor(e) {
    var t;
...
function I1(e, t, i, s, o) {
  ...
  return Object.values(e).filter((f) => {
    ...
    if (!(f.area_id != null || y && y.area_id != null) || r && !((((b = f.labels) == null ? void 0 : b.some((W) => r.includes(W))) ?? !1) || (((V = y == null ? void 0 : y.labels) == null ? void 0 : V.some((W) => r.includes(W))) ?? !1)) || n && !(f.area_id !== void 0 && f.area_id !== null && n.includes(f.area_id) || y && y.area_id !== void 0 && y.area_id !== null && n.includes(y.area_id)))
      return !1;
    if (a) {
      const O = f.area_id ? g.get(f.area_id) : void 0, W = y != null && y.area_id ? g.get(y.area_id) : void 0;
      if (!(O && a.includes(O) || W && a.includes(W))) return !1;
    }
...
const B = (e, t) => e ? typeof e == "object" ? Object.entries(e).reduce(
  ...
  {}
)) : {}, Bo = (e, t, i) => t && t._parsedCss ? t._parsedCss : e ? B(e) : {}, Fo = At`
...
function se(e, t, i, s, o, n, a, r) {
  const l = Z(i, s), c = Vt(t, l, r), d = (c == null ? void 0 : c.invert) === !0;
  switch (i) {
    case "device_tracker":
      return jo(e, d);
    case "lock":
...
const Ko = [
      ...
      (t, i, s, o) => {
        ...
        if (i === "state") {
          ...
          return a.sort((c, d) => {
            ...
            if (h !== p) return h - p;
            const u = z(c.entity_id), _ = z(d.entity_id), v = o ? U(o, c.state, u) : c.state, g = o ? U(o, d.state, _) : d.state, f = (v || "").localeCompare(g || "");
  ...
  _getPopupCardConfig(t) {
    ...
    if (this.selectedGroup !== void 0 && ((v = i._config.content) != null && v[this.selectedGroup])) {
      const S = i._config.content[this.selectedGroup], b = i.getCustomizationForType(S);
    ...
    const s = z(t.entity_id), o = this.selectedDomain || s, n = this.selectedDomain ? this.selectedDeviceClass : (y = (C = (f = (g = this.hass) == null ? void 0 : g.states) == null ? void 0 : f[t.entity_id]) == null ? void 0 : C.attributes) == null ? void 0 : y.device_class, a = Z(o, n), r = typeof (i == null ? void 0 : i.getCustomizationForType) == "function" ? i.getCustomizationForType(a) : void 0, l = r == null ? void 0 : r.popup_card, c = l && typeof l.type == "string" && l.type || "tile", d = c === "tile" ? B1[s] ?? {} : {};
    let h = {};
    if (l && typeof l == "object") {
      const { type: S, entity: b, ...V } = l;
      h = V;
    } else
      h = {};
    const p = {
  ...
  _isEntityActive(t) {
    var r;
    const i = this.selectedDomain || z(t.entity_id), s = this.selectedDeviceClass || t.attributes.device_class, o = Z(i, s), n = typeof ((r = this.card) == null ? void 0 : r.getCustomizationForType) == "function" ? this.card.getCustomizationForType(o) : void 0, a = (n == null ? void 0 : n.invert) === !0;
    return Z1(t, i, s, a);
  }
  _getCurrentEntities() {
    ...
    return m`
      ...
      "ui.panel.lovelace.editor.card.entities.name"
        ...
        <div class="dialog-content scrollable ha-scrollbar" @hass-more-info=${this._handleMoreInfo}>
          ${(Rt = this.card) != null && Rt.list_mode ? v ? m`
...
const Yo = (e, t, i, s) => s ? [] : Object.values(e).filter(
  ...
  return e.extra_entities ? e.extra_entities.reduce((o, n) => {
    ...
    const l = s.indexOf(n), c = l >= 0 ? l : 0, d = R1(
      e,
      n,
      void 0,
      a,
      ...
      void 0,
      i
    ) || ((r == null ? void 0 : r.activate_state_color) ?? e.activate_state_color ? Vo(a) : void 0) || e.color, u = Ro(
      e,
      n,
      void 0,
      i
...
function sn(e, t, i, s, o) {
  var p;
  const n = e.__registryEntities || [], a = e.__registryDevices || [], r = e.__registryAreas || [], l = i || new Map(n.map((u) => [u.entity_id, u])), c = s || new Map(a.map((u) => [u.id, u])), d = o || new Map(r.map((u) => [u.area_id, u])), h = U1(
    t,
    n,
    a,
    r,
...
let $ = class extends R {
  ...
  _isOn(e, t) {
    const i = this._baseEntities(e, t), s = Z(e, t), o = this.getCustomizationForType(s), n = (o == null ? void 0 : o.invert) === !0;
    return i.filter(
      (a) => Z1(a, e, t, n)
    );
  }
  ...
  _computeTabStyles(e, t = "domain", i) {
    const s = this._computeActionHandler(
      ...
      H1((e == null ? void 0 : e.double_tap_action) ?? this._config.double_tap_action)
    ), o = {
  ...
  renderGroupTab(e, t) {
    ...
    const n = e.group_id || `${this.hass.localize("component.group.entity_component._.name")} ${t + 1}`, a = e.group_icon || is, r = M1(
      this._config,
      n,
      void 0,
      this._customizationIndexMemo(this._config.customization)
  ...
  _getInlineCardConfig(e, t) {
    ...
    const s = z(t.entity_id), o = t.attributes.device_class, n = this.getCustomizationForType(
      Z(s, o)
    ), a = n == null ? void 0 : n.popup_card, r = a && typeof a.type == "string" ? a.type : "tile", l = r === "tile" ? B1[s] ?? {} : {}, c = a && typeof a == "object" ? Object.fromEntries(
  ...
  _getOrCreateInlineCard(e, t) {
    ...
    const r = document.createElement("div");
    return r.classList.add("inline-card-placeholder"), this._inlineCardElementCache.set(i, { hash: o, el: r }), ge(this.hass, s).then((l) => {
  ...
  renderInlineGroup(e) {
    const { ruleset: t } = e, i = this._getGroupEntities(t);
    if (!i.length) return m``;
    const s = this.getCustomizationForType(t.group_id), o = Math.max(
      1,
      Number((s == null ? void 0 : s.columns) ?? this._config.columns ?? 4)
    );
    return m`
      <section class="inline-group">
        <div class="inline-group-header">
          <span>${t.group_id}</span>
          <span class="inline-group-count">
            ${i.length}${t.group_status ? ` ${t.group_status}` : ""}
          </span>
        </div>
        <div
          class="inline-group-entities"
          style=${E({ "--inline-group-columns": String(o) })}
        >
          ${F(
      i,
      (n) => n.entity_id,
      (n) => m`
              <div class="inline-entity-card">
                ${this._getOrCreateInlineCard(t.group_id, n)}
              </div>
            `
    )}
        </div>
        ...
        return m`
                ...
                >
                  ${this.badge_mode ? m`<div
                        class="person-badge"
                        style=${E({
          "--status-card-delayed-badge-color": `var(--${g}-color)`,
          "--status-card-delayed-badge-text-color": this.badge_text_color ? `var(--${this.badge_text_color}-color)` : void 0
                  ...
                  <div class="entity ${dt(d)}">
                    <div class="entity-icon" style=${E(h)}>
                    ...
                    ${this.badge_mode ? "" : m`<div class="entity-info">
                          ${this.hide_content_name ? "" : m`<div class="entity-name">
                                ${((S = r.attributes.friendly_name) == null ? void 0 : S.split(
          " "
        )[0]) || ""}
                              </div>`}
...
var fn = Object.defineProperty, mn = Object.getOwnPropertyDescriptor, Y = (e, t, i, s) => {
...
let K = class extends R {
  ...
  async updated(e) {
    ...
    if (!(!this.hass || !this._config) && e.has("_config")) {
      ...
      const d = this._lastFilter.area, h = this._lastFilter.floor, p = this._lastFilter.label, u = !X(p, c), _ = !X(h, l), v = !X(d, r), g = this._config.content === void 0;
      if (v || _ || u || g) {
        const f = this._dynamicOrder, y = this.possibleToggleDomains.map((S) => this._normalizeContentEntry(S)).sort((S, b) => {
          const V = f.indexOf(S), x = f.indexOf(b);
  ...
  _groupAllEntitiesByDomain() {
    ...
    ), r = this._hiddenEntitiesByDomain(), l = ((S = this.hass) == null ? void 0 : S.states) || {}, c = Array.from(
      /* @__PURE__ */ new Set([...Object.keys(a), ...Object.keys(r)])
    ).filter((b) => [...Q, "person"].includes(b)), d = Ot(
      l,
      this.hass.locale.language
    );
